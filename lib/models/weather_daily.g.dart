...
WeatherDaily _$WeatherDailyFromJson(Map<String, dynamic> json) => WeatherDaily(
      ...
      temperature2mMax: (json['temperature_2m_max'] as List<dynamic>?)
          ?.map((e) => (e as num).toDouble())
          .toList(),
      apparentTemperature2mMin:
          (json['apparent_temperature_min'] as List<dynamic>?)
              ?.map((e) => (e as num).toDouble())
              .toList(),
      apparentTemperature2mMax:
...
Map<String, dynamic> _$WeatherDailyToJson(WeatherDaily instance) =>
    <String, dynamic>{
      ...
      'apparent_temperature_min': instance.apparentTemperature2mMin,
      'apparent_temperature_max': instance.apparentTemperature2mMax,
